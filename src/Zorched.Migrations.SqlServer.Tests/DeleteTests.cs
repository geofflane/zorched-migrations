...
namespace Zorched.Migrations.SqlServer.Tests
{
    ...
    public class DeleteTests
    {
        ...
        public void delete_with_schema()
        {
            ...
            Assert.AreEqual("DELETE FROM [dbo].[Foo]", op.CreateSql());
        }
        ...
        public void delete_no_schema()
        {
            ...
            Assert.AreEqual("DELETE FROM [Foo]", op.CreateSql());
        }
        ...
        public void delete_with_wherecolumn()
        {
            ...
            Assert.AreEqual("DELETE FROM [dbo].[Foo] WHERE [Bar]=@Bar", op.CreateSql());
        }
        ...
        public void delete_with_whereclause()
        {
            ...
            Assert.AreEqual("DELETE FROM [dbo].[Foo] WHERE  Bar=123", op.CreateSql());
        }
    }
}